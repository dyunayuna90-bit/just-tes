...
const i18n = {
    ...
    es: {
        ...
        extractingEpub: "Extrayendo EPUB...", analyzingStruct: "Analizando estructura...", analyzingStructure: "Analizando estructura...", extractingChapter: "Extrayendo capítulo",
        welcomeTitle: "Bienvenido a Baca.", welcomeDesc: "Por favor, lee estas instrucciones para una experiencia de lectura óptima.",
        welBackup: "Copia de seguridad", welBackupDesc: "Usa la función de copia de seguridad en Configuración. Los datos se guardan como un archivo JSON directamente en la carpeta <b>Documents</b> de tu dispositivo. Para restaurar, simplemente selecciona ese archivo.",
        welFormat: "Limitaciones de formato", welFormatDesc: "<b>PDF:</b> Solo texto. Se ignoran las imágenes.<br><b>EPUB:</b> Totalmente compatible.<br><b>TXT & MD:</b> Totalmente compatible.",
        welPrivacy: "Privacidad total", welPrivacyDesc: "Procesado localmente en tu dispositivo.", welBtn: "Entendido",
        setMainTitle: "Configuración", setPalette: "Paleta de temas", setLang: "Idioma", setInfo: "Información y soporte",
        btnInfo: "Ver instrucciones", btnDonate: "Invítame a un café", btnClose: "Cerrar",
        setData: "Datos de la aplicación", btnBackup: "Crear copia", btnRestore: "Restaurar",
        
        // Teks Sistem Cek Update
        btnUpdate: "Buscar actualizaciones",
        updateChecking: "Comprobando versión...",
        updateLatestTitle: "Actualizado",
        updateLatestDesc: `Estás ejecutando la última versión.`,
        updateAvailableTitle: "¡Actualización disponible!",
        updateAvailableDesc: "La nueva versión ya está aquí. ¿Abrir la página de descarga ahora?",
        updateError: "Error al buscar actualizaciones. Comprueba tu conexión a internet.",
        btnDownload: "Descargar",

        navBack: "Volver", navToc: "Índice", navSearch: "Buscar", navText: "Texto", navFull: "Completa",
        readerLoading: "Cargando libro...", tocTitle: "Índice", setTitle: "Apariencia",
        setTheme: "Modo de tema", setSize: "Tamaño de texto", setAlign: "Alineación", setFont: "Tipo de letra",
        searchPlaceholder: "Buscar en el libro...", searchNotFound: "No se encontró.",
        ...
        shapeDyn: "Dinámica", shapeRound: "Redondeada", shapeSquare: "Cuadrada",               
        rawBakTitle: "Datos de respaldo", rawBakDesc: "Debido a las restricciones del dispositivo, copia el texto a continuación y guárdalo de forma segura en tus Notas o en un archivo de texto.", rawBakCopy: "Copiar texto", rawBakClose: "Cerrar",
        rawResTitle: "Restaurar datos", rawResDesc: "Pega aquí el texto JSON de tu respaldo O elige un archivo JSON de tu dispositivo.", rawResFile: "Elegir archivo", rawResProcess: "Procesar texto", rawResClose: "Cancelar",
